...
**Security Student | Vibe Coder | Hardware & Security Researcher**
...
Ana odağım; tehdit modellerini anlamak, zafiyet analizini öğrenmek ve karmaşık güvenlik konseptlerini hızlıca çalışan prototiplere dönüştürmektir. Sınırları test etmeyi, hızlı öğrenmeyi ve modern araçları sistemlere entegre etmeyi seviyorum.

### Learning Path & Research Areas
...
* **Languages:** Python, Rust (Learning), Go, Bash, C++
* **Micro-Hardware:** ESP32, M5Stack, STM32 (Basic)
* **Tooling:** Burp Suite, Nmap, Wireshark, Metasploit, Shodan
* **Infrastructure:** Docker, Linux System Administration, Git Workflow
...
* **ShadowNet (World Monitor)**
    * API entegrasyonları ile havacılık telemetri verilerini işleyen 3D gerçek zamanlı görselleştirme çalışması.
* **Tactical Micro-Hardware Frameworks**
    * M5Stack ve ESP32 üzerinde sinyal analizleri ve özel firmware denemeleri için geliştirilen test yazılımları.

---

### GitHub Metrics

![Mert's GitHub Stats](https://github-readme-stats.vercel.app/api?username=redriverr&show_icons=true&theme=transparent&hide_border=true&title_color=ffffff&text_color=aaaaaa&icon_color=ffffff)
![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=redriverr&layout=compact&theme=transparent&hide_border=true&title_color=ffffff&text_color=aaaaaa)
